...
while(i<=m):
    ...
    rnd_search_cv.fit(xTrain, yTrain, epochs = 6, validation_data = (xTest, yTest), callbacks = [keras.callbacks.EarlyStopping(patience = 10)])
...
model.save("modelo_definitivo3(ALt2).h5")
