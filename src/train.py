...
model = RNN.RNNmodel(input_shape = (x_train.shape[0], x_train.shape[1]), units = 5, output_size = 4)
...
history = model.fit(x_train, y_train, shuffle = False, epochs = 4, batch_size = 32, validation_data = (x_val, y_val))
